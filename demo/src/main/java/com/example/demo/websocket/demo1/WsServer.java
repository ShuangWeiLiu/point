package com.example.demo.websocket.demo1;
...
public class WsServer extends WebSocketServer {
    ...
    private void sendMsgToAll(WebSocket conn, String msg) {
    	WsPool.sendMessageToOthers(conn, msg);
    }
